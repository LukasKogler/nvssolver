    ...
    def SolveInitial(self, timesteps=None, iterative=True):
        ...
        if not timesteps:
            ...
            if iterative:                
                ...
                #BramblePasciakCG(blfA, blfB, None, temp, temp3, preA, preM, sol, initialize=False, tol=1e-10, maxsteps=500, rel_err=True)
